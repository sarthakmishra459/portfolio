...
function Faq() {
    ...
    const faq = [{ question: "Are you a Blockchain Developer?", answer: "Yes I develop blockchain Dapps using Solidity, Ethers.js, Hardhat, and Metamask. I also build apps on top of Solana chain using Solana Web3.js SDK, Anchor and Rust." }, { question: "Do you only build Blockchain Dapps?", answer: "No, I am also a full stack developer and I develop websites and web apps using Next.js, Node.js, Express.js, and MongoDb. I can build off chain apps as well." }, { question: "Are you exploring other domains?", answer: "Yes currently I am learning Data Science and Machine Learning using Python. I am also exploring the domain of NFTs and DeFi." }, { question: "How many projects have you made?", answer: "I have built a few projects on top of blockchain technology, machine learning and Generative Ai and some of then have been deployed as well. You can check them out on  Github." }]
